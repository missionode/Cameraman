...
|----|-----------|-------|-----------------|----------|
| **TC001** | Camera Initialization | 1. Open the application.<br>2. Allow Camera permissions. | Viewfinder displays live feed. Dynamic Island shows "Ready". No console errors. | High |
| **TC002** | Standard Recording | 1. Tap the **Record** button.<br>2. Record for >10 seconds.<br>3. Tap **Stop**. | Timer increments in Dynamic Island. Island pulses red. File is saved to default/chosen location with correct extension (.webm/.mp4). | High |
| **TC003** | Photo Capture | 1. Tap the **Capture** (Camera icon) button. | Screen flashes white. Shutter sound plays. Image saved as PNG. | Medium |
| **TC004** | Camera Switch | 1. Tap the **Rotate Camera** button. | Camera feed flips between User (Front) and Environment (Back). Feed resumes instantly. | Medium |
| **TC005** | Audio Capture | 1. Record a video while speaking.<br>2. Play back the file. | Audio is clear and synced with video. | High |
